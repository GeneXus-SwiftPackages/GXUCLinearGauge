...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-2.1.3.xcframework.zip",
			checksum: "7a08f116f710b2e7027de2061f367837ce0f368c3af5adc41626bd500f8c4870"
		)
	]
)