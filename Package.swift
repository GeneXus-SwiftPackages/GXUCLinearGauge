...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.13.xcframework.zip",
			checksum: "8e8eb41925de32c6c4ed836bbe7df8cfcf354f851721b099eb26aa672b7be781"
		)
	]
)