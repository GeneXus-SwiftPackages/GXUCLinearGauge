...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.1.0-beta.25.xcframework.zip",
			checksum: "d98aaf2f24e5afda98900f060a5a06d71e0cc4c0eeb3796c261166da0cd31a65"
		)
	]
)