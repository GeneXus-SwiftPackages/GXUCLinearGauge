...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.17.xcframework.zip",
			checksum: "4134ff37f35c427c49c1f30621e1d0385dfe299b7726bc6bc2950a24d1286ff0"
		)
	]
)