...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-1.2.0-rc.1.xcframework.zip",
			checksum: "549058a7dbcce71d377ac926e2c32256bc635e8d7eac22e24625232e34b54360"
		)
	]
)