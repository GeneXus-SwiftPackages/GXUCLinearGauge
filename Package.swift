...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.17.xcframework.zip",
			checksum: "8646f88589d51b8f20b52ac21514ee7ad6dc87dda1fabe798aaa5381b7f1f65f"
		)
	]
)