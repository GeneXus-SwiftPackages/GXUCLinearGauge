...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.18.xcframework.zip",
			checksum: "e4c47dd40cac2fffecde9513cfb620aa3858aace814e42041c56aa13c0497992"
		)
	]
)