...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta+20230605162159.xcframework.zip",
			checksum: "776b9fa2e3d81fd1bb1ced3b31ad24b3aed59ad59d8652054d870c038d40e315"
		)
	]
)