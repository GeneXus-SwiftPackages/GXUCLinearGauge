...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.33.xcframework.zip",
			checksum: "bdb5f56344cbb7bc0501e8a016334a473048accebcf6b578ffc3d14c8634b3fa"
		)
	]
)