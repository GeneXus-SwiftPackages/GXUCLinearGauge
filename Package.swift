...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.0.0.xcframework.zip",
			checksum: "1c7d69d6550c824743ef89867bf9fff61b0e9d817a4025ce6a62ea47f74e31b5"
		)
	]
)