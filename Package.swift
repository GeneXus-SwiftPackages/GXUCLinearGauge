...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.21.xcframework.zip",
			checksum: "d78b5a0bf691ed9087a511bca009c4a1cc2033a8dbb1508b226af8c75e5ce11e"
		)
	]
)