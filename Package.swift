...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.24.xcframework.zip",
			checksum: "5ce65f1625a0761af78085bf9b7b4f0aa2f4627878436c61ee86d89d99ae743a"
		)
	]
)