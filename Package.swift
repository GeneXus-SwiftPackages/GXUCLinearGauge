...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.19.xcframework.zip",
			checksum: "e186326de83f24beaf4b1019d36bc2e419e01ae071acec5ae2ba36739098a2c1"
		)
	]
)