...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-1.4.0-rc.21.xcframework.zip",
			checksum: "951a0d4beb4e30856df1bc09f5f1ffa22b88f0b65c5e4f0821db431adc500f3e"
		)
	]
)