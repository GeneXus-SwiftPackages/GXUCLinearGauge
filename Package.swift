...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.41.xcframework.zip",
			checksum: "a90f34d53a929afe7f68a8aed52ea0235ca085876dfa19a033b79ebd74659d4a"
		)
	]
)