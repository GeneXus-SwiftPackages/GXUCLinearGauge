...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.36.xcframework.zip",
			checksum: "fc7bfcb43e8fd92d2592e99f97f4a2d1b6c81d94ade4509418dfd2ac7c7e02dd"
		)
	]
)