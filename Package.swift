...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.29.xcframework.zip",
			checksum: "f712b5d33b0083c83c7740d066b3f7bddfa8a2d85ff41a54be2c9263584b4fc9"
		)
	]
)