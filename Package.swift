...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.1.3.xcframework.zip",
			checksum: "c58cffddfd673f4d82c2ef5cb00b5738ff3c1dc0740d3b18eb8e48a0912d6aec"
		)
	]
)