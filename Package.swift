...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.5.xcframework.zip",
			checksum: "5c286c5a82d08d65493ea68b30a4e3693a9c51a606ebef276e192631edd3647d"
		)
	]
)