...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.33.xcframework.zip",
			checksum: "e512d6b45e208e623ef8e70b6d2fce33617f136ae977413201319cd116dd14a8"
		)
	]
)