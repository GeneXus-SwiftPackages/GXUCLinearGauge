...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.17.xcframework.zip",
			checksum: "049aa1bf3c731bea921374662b4f58d3f6bb81d9f551571a1cb40a868e70a4f4"
		)
	]
)