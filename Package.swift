...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-2.1.0.xcframework.zip",
			checksum: "7c7d5a1e0272ebf2a3a7a4b29bd073d8e5cc0d802f8410f4bf0a341d38ef3fc7"
		)
	]
)