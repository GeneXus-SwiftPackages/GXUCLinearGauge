...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.25.xcframework.zip",
			checksum: "fc2e84824b6d4544c02058904c105e0cc2e5b8aac85ec36003f9a85faeea4721"
		)
	]
)