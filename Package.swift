...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.2.xcframework.zip",
			checksum: "3ee7128db40e582494ed0da64af83989383348e9f9eb77e3c5419a7e62db157a"
		)
	]
)