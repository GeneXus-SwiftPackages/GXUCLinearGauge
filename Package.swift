...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.24.xcframework.zip",
			checksum: "4f52eec5607d4e2feb6ee4af696f36218ae94768149bdf5f7a058e20c55661ac"
		)
	]
)