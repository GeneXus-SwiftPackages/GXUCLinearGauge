...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.8.xcframework.zip",
			checksum: "85cb4094ee74103935a8794792deca5e4cdfbeb4e8bceaad4f3f1479936721fc"
		)
	]
)