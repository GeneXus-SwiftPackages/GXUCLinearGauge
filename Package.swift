...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.9.xcframework.zip",
			checksum: "576da6b44b1fa1ec2ee4c90d8722a0d16311eae0b80677e88540f5a8cf2f37eb"
		)
	]
)