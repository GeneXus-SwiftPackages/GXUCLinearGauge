...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-2.0.17.xcframework.zip",
			checksum: "b32d31a25210785f9958c8d9736a9884dba44b9bdc17b61d56a44f49c28efceb"
		)
	]
)