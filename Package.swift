...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.0.4.xcframework.zip",
			checksum: "b357c7974f154dafff2d729e2380a8b9813d4fc3b260233979923d8200c0bcdb"
		)
	]
)