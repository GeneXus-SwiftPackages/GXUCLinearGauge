...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.26.xcframework.zip",
			checksum: "7da02082aed04e298f2fde01fa041d3c36c5bce5d4cd2ba925540da82d871c7c"
		)
	]
)