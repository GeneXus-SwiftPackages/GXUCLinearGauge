...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.12.xcframework.zip",
			checksum: "f359c84c03dc8dc1ad650f064cc8f93331206f853684f2115dcb019aeff9d640"
		)
	]
)