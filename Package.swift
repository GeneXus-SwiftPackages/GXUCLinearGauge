...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-3.1.4.xcframework.zip",
			checksum: "40474890d634f64f0d9a25060921679b08ce035b08897fbf27b3564d8663b5ea"
		)
	]
)