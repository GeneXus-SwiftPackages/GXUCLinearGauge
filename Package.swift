...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.15.xcframework.zip",
			checksum: "e11b95eff2ad64bf41df8d072e39a0db477072191d015cb77130380c5cb300d2"
		)
	]
)