...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.30.xcframework.zip",
			checksum: "74292ce761bda30e8b8cdb233e863dfa1a5f847ec7c622fb013d4c315393c62c"
		)
	]
)