...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.0.0-beta.0.xcframework.zip",
			checksum: "cd7cf5b07f6f7a3d6cbfbc92a2d467ef47d32ca6cc9172a474257b20e93a5998"
		)
	]
)