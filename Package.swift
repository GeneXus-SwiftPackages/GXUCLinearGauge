...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.32.xcframework.zip",
			checksum: "97141e01f999cb7f5ee5e8881d3fc9bd8c39c6039f6fb9db9cacb4a0cc9c0c8c"
		)
	]
)