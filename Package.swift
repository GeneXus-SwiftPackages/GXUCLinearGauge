...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.15.xcframework.zip",
			checksum: "c45ca22592ecf3b2cb4c2ed0c80c4d4a74e4f8bb6cfad8f112cf36d78c66c83b"
		)
	]
)