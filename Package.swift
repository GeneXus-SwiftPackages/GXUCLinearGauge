...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.4.27.xcframework.zip",
			checksum: "de2fdb897e87d8f5ff074e5980aa6535b08d85a737d512443b261444601898c6"
		)
	]
)