...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta+20230316174639.xcframework.zip",
			checksum: "56fd1778716124d03994738c0f3e242fd3a12980ca2fcfe0e0293a146bf6d3d7"
		)
	]
)