...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.4.xcframework.zip",
			checksum: "dcb965e98adc52a2b602e0d88625a507a93ea3b3d4a96d64d320d42a49e53354"
		)
	]
)