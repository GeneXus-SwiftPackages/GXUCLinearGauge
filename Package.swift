...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.8.xcframework.zip",
			checksum: "cd6c4bba045a6efdd7e70f56d96cf2420ae4b15a09d846ff9cc0a924be6bf9af"
		)
	]
)