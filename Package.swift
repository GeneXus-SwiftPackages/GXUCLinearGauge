...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.24.xcframework.zip",
			checksum: "0510854e27f34912beff4e19292a62b21fcb3fdb08b12a6823562994636f6392"
		)
	]
)