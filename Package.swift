...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.22.xcframework.zip",
			checksum: "68c8bb2582bf6e4541e49c2e453b65c22e18b03a60841f1634b20e88a594e2f7"
		)
	]
)