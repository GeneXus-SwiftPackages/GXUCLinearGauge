...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.38.xcframework.zip",
			checksum: "ede9bfc5b523df5e53c17537e75887b2dbd910880623f1ec018c0c5a96959894"
		)
	]
)