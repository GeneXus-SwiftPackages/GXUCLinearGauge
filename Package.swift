...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-3.0.2.xcframework.zip",
			checksum: "c9621c53653f20bc4f983ce57b4cfce7d99fe16b541b5a41c78946b880e957b5"
		)
	]
)