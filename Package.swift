...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.10.xcframework.zip",
			checksum: "f3e9084f78a0c418f272c07ef3e30c76e70321253fbddf384bca6c80751d73c2"
		)
	]
)