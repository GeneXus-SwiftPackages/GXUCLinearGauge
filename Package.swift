...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-3.1.0-rc.8.xcframework.zip",
			checksum: "9e04445040eaa5916063be91e6547f3d1736b839efedcb7d5ed37d8bf35a0e7c"
		)
	]
)