...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.33.xcframework.zip",
			checksum: "9c50abeb7b981175ffe985d9bdf0edfe2c7e29f85be21529d220bee003dbbefe"
		)
	]
)