...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-3.2.0-rc.11.xcframework.zip",
			checksum: "b57c7039f8927a8085407dd8724bddaf909c0b41d70b0d9ed54133ae2bff95a6"
		)
	]
)