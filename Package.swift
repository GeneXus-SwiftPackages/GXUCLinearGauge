...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-3.1.1.xcframework.zip",
			checksum: "44aa06c9a469e89930df32b57838570900f95f1ffec315f9e60837a6874fd75b"
		)
	]
)