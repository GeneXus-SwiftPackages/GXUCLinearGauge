...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.1.2.xcframework.zip",
			checksum: "4f60011fef5c9818a5b99c0a9814b3c8059754371432cc52c87dc4bb88ba8b00"
		)
	]
)