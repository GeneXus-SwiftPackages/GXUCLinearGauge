...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.1.0-beta.26.xcframework.zip",
			checksum: "a1730634cbe50b75f29157f23d4dbdf4f654d4ab2356cbac314e703745e0741c"
		)
	]
)