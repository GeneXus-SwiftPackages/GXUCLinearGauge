...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.13.xcframework.zip",
			checksum: "9730b1b55e57d8a68fee71b9a76f7bed74905f1f5bb20b75cad841f90ac7d4d2"
		)
	]
)