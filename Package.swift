...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.12.xcframework.zip",
			checksum: "b5df18ce84af87716ba1c9e3c39a8b43979f1806826fc31a0327b3542088784a"
		)
	]
)