...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.4.26.xcframework.zip",
			checksum: "fa6032f4d109101527149c9c244964203d40020c73eea4a69f9e4605755d0740"
		)
	]
)