...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-2.2.0-rc.3.xcframework.zip",
			checksum: "282b19e65fbd75e013ffa0154a5854bec7357e4a88545469fb2f087eeddce278"
		)
	]
)