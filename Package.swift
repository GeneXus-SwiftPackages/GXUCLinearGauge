...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.2.0-rc.0.xcframework.zip",
			checksum: "de905e5581defec4d95d9d882a4b85bd266a53b95b6343dc62b90a0632e94e86"
		)
	]
)