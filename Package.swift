...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.3.6.xcframework.zip",
			checksum: "a3baf1f823715a34efd5bfd203fb141b4a50b2f612287a08a81e189613d272a2"
		)
	]
)