...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.21.xcframework.zip",
			checksum: "904fd77ef2de3c9fa61151585633449460950c92cecf678b8f556aa9cd2f278b"
		)
	]
)