...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.7.xcframework.zip",
			checksum: "2392e19d94919be90f435d1e0fa990f0335dc9bd88ba21fe5da2328a30ec5fbc"
		)
	]
)