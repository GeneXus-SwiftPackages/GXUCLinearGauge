...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.5.11.xcframework.zip",
			checksum: "56f84f24dcc3c131f02f8bcf4f96f6131bc0e5223c9524ea8ee373e84e10ae5a"
		)
	]
)