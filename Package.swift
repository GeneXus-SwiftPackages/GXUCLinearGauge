...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.20.xcframework.zip",
			checksum: "eeba15ff994357cb47f9cf69419694d97780ed71e7fcba63994a0c2e16cf5c3f"
		)
	]
)