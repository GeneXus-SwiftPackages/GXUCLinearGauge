...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-1.2.0-rc.15.xcframework.zip",
			checksum: "409707602b6caf04885d739b013ee903f4e9ec368ae7db84804f09d411f7ce11"
		)
	]
)