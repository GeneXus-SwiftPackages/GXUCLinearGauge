...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta.20230710170706.xcframework.zip",
			checksum: "c2df96ddb102bd8dfb223454e1d099e4da1b9ed8da52ff56b24eee0424860244"
		)
	]
)