...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.25.xcframework.zip",
			checksum: "bbe2f8ee1d74dd4de0c102b15c85dcde935a03e6b9173cf0d2ec347b039ba241"
		)
	]
)