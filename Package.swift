...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.5.12.xcframework.zip",
			checksum: "3268abdffd883ca121c177a47807741bb6469329bc46065e939a60650513655a"
		)
	]
)