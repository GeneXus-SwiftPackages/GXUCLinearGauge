...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.21.xcframework.zip",
			checksum: "ddca5070f39ac3d759c8fa8c84f5991b16a925cc44cfdbf80c238f517f5b1406"
		)
	]
)