...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.9.xcframework.zip",
			checksum: "b29335454f9dee2514ddadb766ca63986541fe064ebb2f89fd56771f97a43f93"
		)
	]
)