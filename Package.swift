...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.20.xcframework.zip",
			checksum: "4dec313cc0c9b3b21716e72b10200d2431b520cb84f65d0773fc40c1cc116d26"
		)
	]
)