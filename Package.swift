...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.22.xcframework.zip",
			checksum: "7731eee800f2663a0244d98693a9554e86d53d5b917c6284f35d4d585526af06"
		)
	]
)