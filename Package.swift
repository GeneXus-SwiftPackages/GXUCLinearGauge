...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.9.xcframework.zip",
			checksum: "c353e123c547beb14d5d1d148635f8af7877ce014c3f989e14a85a13c6bee025"
		)
	]
)