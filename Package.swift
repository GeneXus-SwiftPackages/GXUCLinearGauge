...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.7.xcframework.zip",
			checksum: "a7199337ec7597cd54bb9569be81fd2563cc90d0d7817d0deff68ec47418d4c4"
		)
	]
)