...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.23.xcframework.zip",
			checksum: "e49d45380c243cc1975a53d6e41df3a91bc88c406281a01e6ece3c44fdac9b8a"
		)
	]
)