...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.0.0-beta.44.xcframework.zip",
			checksum: "b02fee2eaf089522115dc7f4b8f088609330a9c04c9b8570d35dc08fcd170111"
		)
	]
)