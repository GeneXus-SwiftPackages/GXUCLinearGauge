...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.28.xcframework.zip",
			checksum: "f385ab90dedd8c605e3c707a1f2d6ffa0c8cfea1b49cb5ca78240e0ee1dcbe53"
		)
	]
)