...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.25.xcframework.zip",
			checksum: "8192145c54e81d5edb1aaabd944ced4ae3dc191a0eb780b1863762a26532463b"
		)
	]
)