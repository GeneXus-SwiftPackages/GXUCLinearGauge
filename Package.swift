...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.37.xcframework.zip",
			checksum: "673ca94c69e2042a9405b570a90966c13310bf9128266213b8c5e7cdb0abab59"
		)
	]
)