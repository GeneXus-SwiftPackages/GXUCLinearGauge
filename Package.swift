...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.1.xcframework.zip",
			checksum: "95f795a83dcdcfba1d17fb8e0cc562e20d0e3b07b1fc33ea3d6606aed070fc64"
		)
	]
)