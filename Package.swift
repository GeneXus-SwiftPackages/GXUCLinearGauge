...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.9.xcframework.zip",
			checksum: "f34cc42d6092ab49beef91c89c521f4a2d2bb01da5dcdf310e672c7e6eced631"
		)
	]
)