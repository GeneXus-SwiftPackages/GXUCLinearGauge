...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.0.0-rc.0.xcframework.zip",
			checksum: "844416f182c63a07ee946b81544b147ced78350ebcfdadf2fcf6678c64986ae1"
		)
	]
)