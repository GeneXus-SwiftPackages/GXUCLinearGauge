...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.12.xcframework.zip",
			checksum: "f7e80af24397416270f5a53b3710f76545e082faf89fc0b064be31584ebc5767"
		)
	]
)