...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-5.0.0-rc.1.xcframework.zip",
			checksum: "49eb473a7fd75233484b4aa15730bacf19005d7f0c81005ad59150356ef56d2a"
		)
	]
)