...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.22.xcframework.zip",
			checksum: "5065fd7183a87f530843a7914860bbb4a4a5966fc473954094ceb06ddb68a9c2"
		)
	]
)