...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.19.xcframework.zip",
			checksum: "3a1eab38cba980bf339817cdb5c00fc7033790101edfa11be93f506aba4b5aba"
		)
	]
)