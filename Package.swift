...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta.20230617144628.xcframework.zip",
			checksum: "62e11c203deda1f1c01529f88b66cffe71fd2b5c5765e3d8e317419f638d3326"
		)
	]
)