...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta+20230324150340.xcframework.zip",
			checksum: "780f8bfba045df285c6444f12e2f9eaff472871bccd712a00d8af40cd8131059"
		)
	]
)