...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.6.0-beta.2.xcframework.zip",
			checksum: "4f6f36c6aa4bd598fb60ec90d5b90312b45d8a58aacfaf751bfaf50441d80c08"
		)
	]
)