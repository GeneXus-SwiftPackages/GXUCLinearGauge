...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.2.xcframework.zip",
			checksum: "6068c2f307cc5b085decfcd51ef819d3c9b7c7e59866f6628939a79d611e294e"
		)
	]
)