...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.32.xcframework.zip",
			checksum: "81c5df885ccc7b57e82e3629b625111f3a52ca0cad6216be9654de0a1e17f30f"
		)
	]
)