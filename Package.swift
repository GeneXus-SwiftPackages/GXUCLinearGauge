...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.1.0-beta.795.xcframework.zip",
			checksum: "a5b5f932a830df41aef7993d8b44aad358927bb55d7ea33079c6687866fc5620"
		)
	]
)