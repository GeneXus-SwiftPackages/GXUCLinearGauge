...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.17.xcframework.zip",
			checksum: "c0c9c7b831141a72aa9e41647313baad8ef5a795312099587d0fc378e2b1964e"
		)
	]
)