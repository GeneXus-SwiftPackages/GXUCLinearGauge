...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.6.0-beta.4.xcframework.zip",
			checksum: "9af16d0eb790c239ecac7c4ad0452c6b1c991d409d82b42c2030dcc8430e5039"
		)
	]
)