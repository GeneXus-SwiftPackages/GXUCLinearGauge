...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.21.xcframework.zip",
			checksum: "d6cd42445d4a2e6d51581472a6151b6ce8a9aab876c463734f3d26d6c3f6b831"
		)
	]
)