...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.17.xcframework.zip",
			checksum: "0e98f5baa4dead1e89811ef30b6648345c81bbba5e4389087bf0db3bafdbc693"
		)
	]
)