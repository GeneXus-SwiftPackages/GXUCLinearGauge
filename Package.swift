...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.0.0-beta.45.xcframework.zip",
			checksum: "9530613c49aa11475102b437d11d7939fe502bd2700474523e25c3356000d057"
		)
	]
)