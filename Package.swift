...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta+20230411173940.xcframework.zip",
			checksum: "87c569c8d677e15ccf1ad578fc7eeba5297d9999b263aa47d9f26ccff020453f"
		)
	]
)