...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.9.xcframework.zip",
			checksum: "19dda987a0efd1d0812ea7059e6e00e033a36f00135428bb5637b16599a060d7"
		)
	]
)