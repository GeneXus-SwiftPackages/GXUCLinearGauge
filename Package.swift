...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.11.xcframework.zip",
			checksum: "2ac05dde2cc8de6688b9a7bab917661b53a138653c2bb795b40a72165080b193"
		)
	]
)