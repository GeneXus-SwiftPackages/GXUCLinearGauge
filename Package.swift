...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.11.xcframework.zip",
			checksum: "daac93585877ec8b3b215889f86c3a0e7437f9d916d9b50fd6c138ff981487e8"
		)
	]
)