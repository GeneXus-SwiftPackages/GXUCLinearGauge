...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.20.xcframework.zip",
			checksum: "07013ca59dc8b59ed2e5e91ec0f62804f20996631e688f52934d12b49cedb1d8"
		)
	]
)