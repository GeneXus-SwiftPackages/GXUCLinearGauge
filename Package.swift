...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.6.xcframework.zip",
			checksum: "7eaf8eee5d91953765e70dd759a0ff1223734841f4c11990519df574477fb515"
		)
	]
)