...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.0.7.xcframework.zip",
			checksum: "cbd7d3a04dc84dea6b093e34e14ef12c10141116e1a1b00a7782774714dc3a8c"
		)
	]
)