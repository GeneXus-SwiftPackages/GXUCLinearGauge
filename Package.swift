...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.0.16.xcframework.zip",
			checksum: "62021fb81a63f4dd1164f011dc565ef6d6beba1d265d55880024205d9deaf335"
		)
	]
)