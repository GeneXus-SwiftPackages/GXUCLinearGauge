...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.18.xcframework.zip",
			checksum: "c87895e838c166e86fed04f4bbb0de666727382442213bfaf805ce5ff9448f62"
		)
	]
)