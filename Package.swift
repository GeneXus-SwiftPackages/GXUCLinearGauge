...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.14.xcframework.zip",
			checksum: "b46d7d2d45403c096cd22ea555bc64abe4aa30a097fff4bc2ba68a8565014c73"
		)
	]
)