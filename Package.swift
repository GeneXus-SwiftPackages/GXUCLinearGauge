...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.4.31.xcframework.zip",
			checksum: "4c1d6e17ea6d2e54eb112772c5e7f0a277d0410012d260d4067b1b8255858ae0"
		)
	]
)