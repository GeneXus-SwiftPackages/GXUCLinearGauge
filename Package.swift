...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.3.xcframework.zip",
			checksum: "1ce3d140c4568265a509babf51c58c19061f4c0ee1f1213ffa9a3cf00f9d7a94"
		)
	]
)