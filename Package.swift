...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.1.0-rc.8.xcframework.zip",
			checksum: "9dcf7bbdb4b05118ca8d01c474ac4e9003d81449069cdc024dea0750cf91c6dc"
		)
	]
)