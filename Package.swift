...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.2.0-rc.3.xcframework.zip",
			checksum: "51a3eae4535b2550c9dbd953c153000692e1520a5a50d16f70eaf8c255b8486d"
		)
	]
)