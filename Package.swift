...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.27.xcframework.zip",
			checksum: "3d25720403c57c4fae79897261500d476df80ee1c3cde6db58e365d1268a8bce"
		)
	]
)