...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.25.xcframework.zip",
			checksum: "ff4630c53c7051ddd922c6f4d016594e722d8ef40b4cd5099f3016eefd33c37f"
		)
	]
)