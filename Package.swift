...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-1.6.0-rc.0.xcframework.zip",
			checksum: "b37d0fffc9ca5da54b98fc8678174874a779a5b331c1d74b16b00017f1ed0d2c"
		)
	]
)