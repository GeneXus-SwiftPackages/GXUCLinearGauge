...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.32.xcframework.zip",
			checksum: "dc694532f6979f96045c7e73d0cd177ffd03fb2962197154fe36b2bdb92f59ba"
		)
	]
)