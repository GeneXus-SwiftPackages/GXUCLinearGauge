...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.4.29.xcframework.zip",
			checksum: "ccbe3bb4929cf77b2578873676d5c4a9d11fd061e5f77ef0db73815b45f7c5ce"
		)
	]
)