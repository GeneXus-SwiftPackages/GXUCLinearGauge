...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.24.xcframework.zip",
			checksum: "71aee26e2bb929b41f861c5e3a8f369208b3d744283541287b45e9e6e46d3651"
		)
	]
)