...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.18.xcframework.zip",
			checksum: "1a16be99849142f01ed6c9a5f4659952d52d6dd9869fc8328bc6fb4c6725f441"
		)
	]
)