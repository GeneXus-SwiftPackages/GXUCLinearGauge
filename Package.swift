...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.9.xcframework.zip",
			checksum: "80c67697fa408001043ea0eb27f22933a5c9391b4ad8e1b393e55874f793f13d"
		)
	]
)