...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.7.xcframework.zip",
			checksum: "53e0fe57c4ce50104a53b28554342bafad8356a342928b37d598e584b7f3c54d"
		)
	]
)