...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-2.0.0-rc.32.xcframework.zip",
			checksum: "4487b8c2e7fe4323ce1131bd9348012912e679111b5999e7570f328ead35d612"
		)
	]
)