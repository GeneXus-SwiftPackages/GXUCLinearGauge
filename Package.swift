...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.5.16.xcframework.zip",
			checksum: "c632308ec031185d5aa29f8e8e7bb0d6df9fb0e0fddec327c5dfddd09bbd0aa7"
		)
	]
)