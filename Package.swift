...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.1.5.xcframework.zip",
			checksum: "52a87343b1bc48b0231623b715794f03dcb14a7a227c0286b69b33aca92cd370"
		)
	]
)