...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-2.1.0-rc.25.xcframework.zip",
			checksum: "25e6f9b9b25c706341ccb9702d0d3d3929cab83506495ad8336e93d213291a5b"
		)
	]
)