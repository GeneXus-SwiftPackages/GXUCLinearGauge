...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.19.xcframework.zip",
			checksum: "0afc05eb56d783dead48d3a1f8118cd609c994ce862659118cdcadc7be29d3d9"
		)
	]
)