...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.36.xcframework.zip",
			checksum: "acebb3af0fed27db616ebf13f3cdd01b769b048d6295a631eefb22a0a492b96f"
		)
	]
)