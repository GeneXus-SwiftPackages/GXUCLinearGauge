...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.1.0-beta.7.xcframework.zip",
			checksum: "5852be818cdc3245d937c5d723f6cf6144f5022954bf9af6243792fc87a273e0"
		)
	]
)