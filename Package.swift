...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-5.0.0-beta.5.xcframework.zip",
			checksum: "d8ae1c980fb2e079cc76a6f584231c71f4fb672d3a0a90f49c7b92a7127091f2"
		)
	]
)