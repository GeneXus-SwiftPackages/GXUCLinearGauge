...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.7.xcframework.zip",
			checksum: "8612f1a101b9d20f1b0566e675062d6a093a2007163a5e1c02211a92e36c8825"
		)
	]
)