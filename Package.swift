...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.17.xcframework.zip",
			checksum: "602350ff16cade6a5a3dc47c4c06f4e9ab5fae3a1f8898d209a1603c778b9c27"
		)
	]
)