...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.27.xcframework.zip",
			checksum: "1dc431aa011541629c80d198f3496d62fd36d866a8686ba421d17e52420326e5"
		)
	]
)