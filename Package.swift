...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.11.xcframework.zip",
			checksum: "a80dbfd140d6a2c2b2df197b10dee46f8b91b2a16ad14b951ad99911ec9df855"
		)
	]
)