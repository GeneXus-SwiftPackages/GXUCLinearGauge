...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta+20230509173316.xcframework.zip",
			checksum: "519e04be45fd655c94cc196b379236f44e2338c2d582c43ef98d0ce395d575f6"
		)
	]
)