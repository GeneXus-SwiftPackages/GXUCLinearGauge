...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.6.xcframework.zip",
			checksum: "8c343b89274442c66d6123fa4983f34f6c3c1cc224947e7b9f2ee43ae4d2b3f2"
		)
	]
)