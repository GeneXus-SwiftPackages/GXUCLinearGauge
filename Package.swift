...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.8.xcframework.zip",
			checksum: "f427f4be8142a548bff6a38a1ba52948a0d59db7fa2099dca383e4e8d5699320"
		)
	]
)