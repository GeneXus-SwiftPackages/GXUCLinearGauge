...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.1.0-beta.6.xcframework.zip",
			checksum: "21354cf61d1af091eec90cbef74354204afacc3ff16765c60dcbd0c4549e690b"
		)
	]
)