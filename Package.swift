...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.13.xcframework.zip",
			checksum: "424d8a964b5d115a3098c752f9b532e4119050c5ed5c8c8c030658ee30a38e5b"
		)
	]
)