...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.12.xcframework.zip",
			checksum: "b1b31c1de068b7e7dc5a30ad83ec9dd0484b65a30f4cdc6f4feceeba3f50116c"
		)
	]
)