...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.1.0-beta.9.xcframework.zip",
			checksum: "4ef985adad45a09ea8b8b30da09bfa8bcfc6436f811355ff05e568320c1b285d"
		)
	]
)