...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.19.xcframework.zip",
			checksum: "87714dc8f3996fc4ea831975ee287b07fa7dd517c2cd99dd7b405961bd601545"
		)
	]
)