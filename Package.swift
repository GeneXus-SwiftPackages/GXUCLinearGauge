...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.15.xcframework.zip",
			checksum: "f8bd63397df7537c9b11f4669b1bb8498fba68be6a7eb3fd5455c88632719250"
		)
	]
)