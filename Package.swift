...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.1.1.xcframework.zip",
			checksum: "8cddf18d37fd28c49073d4a226042808b1eb4f71bca02efdaa8aee6130c77390"
		)
	]
)