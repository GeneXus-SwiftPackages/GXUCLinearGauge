...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta.20230701000831.xcframework.zip",
			checksum: "0231dbc75e70edcced8feec788c4be03fb5512793a604276a8b15fc1a9a530cb"
		)
	]
)