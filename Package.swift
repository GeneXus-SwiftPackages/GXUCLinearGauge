...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.1.0-rc.22.xcframework.zip",
			checksum: "7ffc31a71c32850f42de9fe39aff4018311dd2d02823a9cfe0bdd91d438296f9"
		)
	]
)