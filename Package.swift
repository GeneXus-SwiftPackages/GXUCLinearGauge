...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.8.xcframework.zip",
			checksum: "d77a554c2b9396f7d560155c29ed5e90cbf3e42f8331934bf30352711976f180"
		)
	]
)