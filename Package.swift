...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.3.xcframework.zip",
			checksum: "b5e0feed195360d582fd929f60d935a1f1ec0d0e3238fdd060b2af8d345186e9"
		)
	]
)