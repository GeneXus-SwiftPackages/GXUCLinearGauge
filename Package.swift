...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.19.xcframework.zip",
			checksum: "c0a7229ade4fa18e1bd59bbfb30f0d0e3ae0b54d69ca068d062d41bf0ba67090"
		)
	]
)