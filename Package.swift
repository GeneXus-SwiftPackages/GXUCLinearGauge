...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-3.1.0.xcframework.zip",
			checksum: "90e8659e86ab7b36da28d43937a791d992cb979a29fe3a7657e08375d97e25d7"
		)
	]
)