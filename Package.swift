...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.27.xcframework.zip",
			checksum: "d8a0a1440a87e7189ac309a3174f3d0867140856ae769cfd98472360549d0a50"
		)
	]
)