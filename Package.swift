...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.3.xcframework.zip",
			checksum: "ee64cc7bd1411c37f16b7eae0fdb2b00c6d22cb4429cc95a5eae9dacd8d145f5"
		)
	]
)