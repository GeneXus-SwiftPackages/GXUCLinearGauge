...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-2.0.18.xcframework.zip",
			checksum: "3bd638bcfdc332ea8d8f9ff7c0db40668403a13cbc70039c95df9c404b976087"
		)
	]
)