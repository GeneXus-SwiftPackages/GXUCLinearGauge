...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.11.xcframework.zip",
			checksum: "c83ee336079b952c8b8b307b84b768e7ae28be1cd47f6adc54084c25a7248975"
		)
	]
)