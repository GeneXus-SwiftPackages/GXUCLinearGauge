...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.11.xcframework.zip",
			checksum: "2ce70821ba1e444ebba70fee1c6b8cf6cb6786b29010e5ac60dc7be35b4a4ed3"
		)
	]
)