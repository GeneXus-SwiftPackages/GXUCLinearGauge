...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-5.0.0-rc.0.xcframework.zip",
			checksum: "c8e7687bb6d0dc14bbc7342fc822a8f5673b9de032c2bc4971ee200441211cc4"
		)
	]
)