...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-5.0.0-beta.4.xcframework.zip",
			checksum: "19736eaa9c51ab67250035f78cd2e0eaeb8a7da45dfc4ffbbbbefc04d894aa73"
		)
	]
)