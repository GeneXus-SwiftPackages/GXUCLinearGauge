...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta.20230717172207.xcframework.zip",
			checksum: "11727e8404a5e0f4a9bb49d21afedeed6fee31229a92777d9e9834231f3a704e"
		)
	]
)