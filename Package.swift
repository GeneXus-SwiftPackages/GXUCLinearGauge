...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.25.xcframework.zip",
			checksum: "e81ce53e09c4f1cf7f3ead7f0433794dcafd684787d51e9ea78cf43fe86f3ea1"
		)
	]
)