...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-3.0.0.xcframework.zip",
			checksum: "3b2e3f50d8ea5a60bf7086059767ccc689a6fc508350aa104ce654a952a38cce"
		)
	]
)