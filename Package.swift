...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.1.0-rc.3.xcframework.zip",
			checksum: "fba8248fd37440f8c059a14e2b908c36cad52252980a98c2de24fcacb4c7048c"
		)
	]
)