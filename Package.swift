...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.0.xcframework.zip",
			checksum: "4bb6f808298dd28502b24d70f05f5a3559410c508e2a870206918a0d0bdd341d"
		)
	]
)