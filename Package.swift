...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.20.xcframework.zip",
			checksum: "7bf2e69ef155695e71272799441f722dd743d67be0eea6d09cc618830851d10e"
		)
	]
)