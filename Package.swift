...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.0.9.xcframework.zip",
			checksum: "5e6c04935b61c862dd806f2b570a1c290ed859e026063d98c1fdbafb07744a20"
		)
	]
)