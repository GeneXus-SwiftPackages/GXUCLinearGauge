...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-3.2.0-rc.12.xcframework.zip",
			checksum: "2d975784bbb19b960a3a37e11fb416ae06836d83dcfced64ae4e284411ad2f77"
		)
	]
)