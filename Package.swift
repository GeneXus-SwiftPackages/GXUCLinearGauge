...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.28.xcframework.zip",
			checksum: "478ec26121eff96aab4f9936c57ba95a387e4c2ffd5c1d6e5c4c109670febd99"
		)
	]
)