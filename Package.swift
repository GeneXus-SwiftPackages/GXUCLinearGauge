...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.4.xcframework.zip",
			checksum: "e2a83c245fbc654a8143d3e36dcf11afc4b3df3be37fc13e0e6c74dd08dc4a41"
		)
	]
)