...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-1.5.0-rc.26.xcframework.zip",
			checksum: "09baffeda10aee067e0daf261a30718be066e1b39e0178d40fedaba74090f067"
		)
	]
)