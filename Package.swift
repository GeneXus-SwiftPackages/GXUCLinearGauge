...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.0.8.xcframework.zip",
			checksum: "45c6520495e5d375d6f397bb930f570248d7745c91aa7298230ec7cee82da973"
		)
	]
)