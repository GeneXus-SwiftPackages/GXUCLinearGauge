...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.16.xcframework.zip",
			checksum: "1bde4a88e63e537b969fc9ad903b21ca88a571d877899d00055647228292f2f9"
		)
	]
)