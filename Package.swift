...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.30.xcframework.zip",
			checksum: "5ff30782a5595133c56d34f0a674bed97ba4ee2073515b40a0ce05d13d2c362c"
		)
	]
)