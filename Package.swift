...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.5.xcframework.zip",
			checksum: "0f4eac6ff473cc3ed4109fb0917e4731edd396e2295e00bf26db66626c202131"
		)
	]
)