...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.31.xcframework.zip",
			checksum: "f03c706e9077fed2950a1d8391ecf47fbe76bccdbb08a9262f2454c057445e5c"
		)
	]
)