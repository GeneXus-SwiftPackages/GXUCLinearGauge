...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.35.xcframework.zip",
			checksum: "207cb2bb1b8e16b0dc1ed821d265e3e79bacebb3c6643837f66264d3ed775f4d"
		)
	]
)