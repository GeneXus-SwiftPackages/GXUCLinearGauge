...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.27.xcframework.zip",
			checksum: "8cc9af28b3b2ba9de69d6858d990384f650792e75764481a8f906b2d2f13a47a"
		)
	]
)