...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.36.xcframework.zip",
			checksum: "bda083eb212fa0848ab7506b2b47c593e0c56be78efa027a8950ff79c4f91b25"
		)
	]
)