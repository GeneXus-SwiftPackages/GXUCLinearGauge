...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.26.xcframework.zip",
			checksum: "45b54361f29e84a04a8ad5e2e21ee0fbe5873f03c02383bea13bb497df9596d2"
		)
	]
)