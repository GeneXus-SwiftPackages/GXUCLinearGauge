...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-2.2.0-rc.1.xcframework.zip",
			checksum: "057b6c623993361ffc11d232cc03bad3190e874f0bc2631c3059625997f021dc"
		)
	]
)