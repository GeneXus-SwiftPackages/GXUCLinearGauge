...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.15.xcframework.zip",
			checksum: "76f2a8380417ee78ecc77674222ae0134e081920f7ae549297f37eea218ddaf0"
		)
	]
)