...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.3.3.xcframework.zip",
			checksum: "b64d7a08a27dfb2317d22c73b1f8866c2aa4c5d2329eeb3edf253e942e79cd4d"
		)
	]
)