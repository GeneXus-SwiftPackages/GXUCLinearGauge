...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.35.xcframework.zip",
			checksum: "3888c556d78933f55305d1805a885586c6218896456c7db06748f5e198f9d265"
		)
	]
)