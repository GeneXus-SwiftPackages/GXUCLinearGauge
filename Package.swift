...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.10.xcframework.zip",
			checksum: "be5f18e107b70508cc2b4922d40c312488c7fa0645a92345ac2d9cefb0064566"
		)
	]
)