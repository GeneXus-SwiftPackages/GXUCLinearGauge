...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.24.xcframework.zip",
			checksum: "b25a70218bd5f7c001a957313769fe06cb8a6ab9309c794bfb870429022bd6b0"
		)
	]
)