...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.19.xcframework.zip",
			checksum: "5674539993685d806cd833b28d801c5cecb2add207fbd6de42d30fd0e8104f9b"
		)
	]
)