...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.41.xcframework.zip",
			checksum: "e439efbf33913de63d271c56ed693f42918ecd88f2b9b0cac46b4b42f2c08e80"
		)
	]
)