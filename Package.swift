...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.15.xcframework.zip",
			checksum: "88c26a5522d4840ffabb8b2d7a4b94808f2b3b4c21c9070e0fa353a8dfa4c15c"
		)
	]
)