...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.5.17.xcframework.zip",
			checksum: "4bd1a46176ac308ece450f4f80ac70a150f3783fc6eaf8dc25a3c270190b3786"
		)
	]
)