...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-1.2.0-rc.29.xcframework.zip",
			checksum: "6d52eb4d2f800f0278da4fbb1fd83b0609f5428fa00712fb19be28c5f8345b72"
		)
	]
)