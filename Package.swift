...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.18.xcframework.zip",
			checksum: "29e37956edd2d4c76ea982703be106346a266b4c2c08097cabb632c7c01340b2"
		)
	]
)