...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.3.xcframework.zip",
			checksum: "b93d349fdf337a5931332ff98a87753d9f2741494e6c52dc98056b89ef7aaf06"
		)
	]
)