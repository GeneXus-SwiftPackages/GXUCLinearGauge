...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.25.xcframework.zip",
			checksum: "e5a72ef4ab619bf60e8a17ca9a0ad77eb72169bf3471b012954a01fd11e54418"
		)
	]
)