...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-1.2.0-rc.25.xcframework.zip",
			checksum: "2849c811b0a7f07758c7c52dd1aa9e09ed6869b7db9248ddca85442f70e59e7d"
		)
	]
)