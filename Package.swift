...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.29.xcframework.zip",
			checksum: "2c5315f05325576e773a0ea78424856e12d4b4dd4046b89a7dde71b76def9beb"
		)
	]
)