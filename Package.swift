...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.19.xcframework.zip",
			checksum: "f002ac5858ad1f04a7cd95dad4ba171fe5de13a45b13e93d4135c0c018d3b1d1"
		)
	]
)