...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.3.5.xcframework.zip",
			checksum: "837bf028eda5d5d068295c844e8182a40894759d1f3ddba8415c0df91f6a813f"
		)
	]
)