...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.10.xcframework.zip",
			checksum: "fb0c81008a2dfbad4f1b59f367b49ee62a46002ddd6d8b77f61845b205dc1582"
		)
	]
)