...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.18.xcframework.zip",
			checksum: "0a48e170898fc676adfbf4c01621387fb3540f547ab4041e937240cccf77561d"
		)
	]
)