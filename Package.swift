...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.23.xcframework.zip",
			checksum: "a8ece05a459afbc368cfa29da3945fe4363ac9250765febe8f83469687b9cf49"
		)
	]
)