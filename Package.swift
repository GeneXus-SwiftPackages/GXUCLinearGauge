...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.23.xcframework.zip",
			checksum: "43cc355ebac7d83239da787ec05f61ffbe287a3d6844eb6d02021f556c6fe91d"
		)
	]
)