...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.14.xcframework.zip",
			checksum: "64711892217771f0add568571db88653d9080c4ea8ac1d4496b6f794350bbef6"
		)
	]
)