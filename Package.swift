...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.10.xcframework.zip",
			checksum: "7adb07b0c2dd492b46aeaa0cc8d31a847f7ff5b8ed5c7c1cd92e07d9c26aa802"
		)
	]
)