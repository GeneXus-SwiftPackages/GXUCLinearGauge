...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.3.xcframework.zip",
			checksum: "cb1c9f572ee9f46c5029249a7c89b75c19e238cb202e1173183afd04706d8b29"
		)
	]
)