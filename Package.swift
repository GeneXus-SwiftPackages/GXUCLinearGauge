...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.18.xcframework.zip",
			checksum: "55fd1e7edef4a0ee3a5865359a60166a3394251c91d3d7ae1416b7f87e3b749f"
		)
	]
)