...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.1.0-rc.14.xcframework.zip",
			checksum: "93af8c35a6fb9637185c3c73c9e07cc78853a43e56970cadeb063ed816e84528"
		)
	]
)