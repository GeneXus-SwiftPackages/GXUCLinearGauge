...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.22.xcframework.zip",
			checksum: "7c287e0f22bd7c875a434fc514aa013ca47e5db1d340f12dbf4af22a39548c5e"
		)
	]
)