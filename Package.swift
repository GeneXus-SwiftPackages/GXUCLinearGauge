...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.5.xcframework.zip",
			checksum: "331c7df38846752209ba705b1dd11c02ee5d39973154df925f4e13de29cd5e58"
		)
	]
)