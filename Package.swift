...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.29.xcframework.zip",
			checksum: "ca34d13e530f71d8da57b9703e3b3b4c171615c61aeb05b4989a55b1457e4470"
		)
	]
)