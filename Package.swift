...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.21.xcframework.zip",
			checksum: "1825defb8b9bb146926fe6b9e453986b2a4813f63176e06504effd526f9bee1b"
		)
	]
)