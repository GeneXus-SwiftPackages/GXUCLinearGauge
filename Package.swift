...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.13.xcframework.zip",
			checksum: "b8f796384b12da408f70f0b831fe5b7cee0d399d1ce4fd8b5e0cc1a591689ac5"
		)
	]
)