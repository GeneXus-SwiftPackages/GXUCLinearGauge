...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.31.xcframework.zip",
			checksum: "ab3f496f8692d1520629d3fc6d65cd3aabadaedff8e42a593a5777f0bc65e8d7"
		)
	]
)