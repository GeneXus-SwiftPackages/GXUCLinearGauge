...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.17.xcframework.zip",
			checksum: "09b15715de4f7edc591dc7e98f7c13ab6cffbcac313e9ba9f825ee5aad8aeca8"
		)
	]
)