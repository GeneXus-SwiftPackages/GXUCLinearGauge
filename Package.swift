...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.2.0-beta.10.xcframework.zip",
			checksum: "f7a5875d980de83b029def85d774bc2c462d9ab098c0a8f4493570fade70ed4f"
		)
	]
)