...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.2.xcframework.zip",
			checksum: "c38354b8410486d79a6200f58344b6f721c2f4d9eaffc08aae0c584be2b2934d"
		)
	]
)