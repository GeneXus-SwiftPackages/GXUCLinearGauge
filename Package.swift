...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta+20230519205149.xcframework.zip",
			checksum: "f8ec2bf0c84e0a0685a5a674b948a805bf9d1ef35771268be7940f1dbbffabd2"
		)
	]
)