...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.4.xcframework.zip",
			checksum: "a7b56d273b9615784f4e57c9f0159000a850bfa62ce6dfc3e9444833db50603d"
		)
	]
)