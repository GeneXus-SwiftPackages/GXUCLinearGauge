...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.6.0-beta.0.xcframework.zip",
			checksum: "d26ffe3ca29e646e5b06aa1f95879d566e3eb7864de97d40f17bb0596d8385f5"
		)
	]
)