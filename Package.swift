...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.6.xcframework.zip",
			checksum: "87c020cd218f6ddce805b90f701bd5970452c7ebbaa63b0261e28510ef4cca6f"
		)
	]
)