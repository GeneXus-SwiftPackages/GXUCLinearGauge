...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.2.xcframework.zip",
			checksum: "72c22d34248bfb8fff875171bdad283a3eea2b57c36dc886e4e9f7ac060ca505"
		)
	]
)