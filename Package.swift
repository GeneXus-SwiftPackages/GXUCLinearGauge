...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.16.xcframework.zip",
			checksum: "b39d0ad4db0c02fae695f5f403a517ff23473959e2e9cdc146cb17f693c00913"
		)
	]
)