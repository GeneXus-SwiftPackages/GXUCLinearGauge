...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-3.2.0-rc.0.xcframework.zip",
			checksum: "a68dc75d4e7924d102d1c8d51a315dffa6d693de907255ea4113735fa6221e54"
		)
	]
)