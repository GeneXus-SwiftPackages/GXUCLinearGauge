...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.5.xcframework.zip",
			checksum: "11f5d244f11f5596ab87ac068ddf6e571d63517ee68cd2b05a5572e84f425f30"
		)
	]
)