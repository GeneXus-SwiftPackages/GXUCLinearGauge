...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.2.xcframework.zip",
			checksum: "6aa33aceaafceaca215ade2f4a9c483340bb105193ac4e98afb6f31499c299a8"
		)
	]
)