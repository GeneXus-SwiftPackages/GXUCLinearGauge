...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.11.xcframework.zip",
			checksum: "3cc637fa5c876f7b0e0729f277d6c120394df62c3c1d6df0defb7615565af67b"
		)
	]
)