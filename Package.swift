...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.2.2.xcframework.zip",
			checksum: "b9ebce6fe12b5f956852ba2e52025daa80356e5f96c1db88cdb13b2d8e12a4a1"
		)
	]
)