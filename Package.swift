...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.12.xcframework.zip",
			checksum: "97e03f7cca909bc7e06a2308b73b070204ec81c4f5e85eede54d8b80b0ccbfe1"
		)
	]
)