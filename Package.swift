...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.4.30.xcframework.zip",
			checksum: "a171673570942e1f30e69ff32da600713f94687cc8e1286a5e3e3c4a10e50ba5"
		)
	]
)