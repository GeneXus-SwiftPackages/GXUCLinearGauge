...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.40.xcframework.zip",
			checksum: "053facbdcdc29836cd5e9ae2b642212903c7ba34eac35517512fa05215548764"
		)
	]
)