...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.6.0-beta.1.xcframework.zip",
			checksum: "6489428f73c02f0a05afa0e3964bedcfca637589a5a397fe510e614d7dadf750"
		)
	]
)