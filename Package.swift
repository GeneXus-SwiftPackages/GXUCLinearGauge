...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.23.xcframework.zip",
			checksum: "774c8c4dd7845f78cfdc000a08f3f28754a0cc00a838599d5fa778ef98021aa5"
		)
	]
)