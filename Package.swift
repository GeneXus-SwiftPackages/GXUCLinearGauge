...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.20.xcframework.zip",
			checksum: "301458d7d1e0b51683aa9263e3e7303e8e76878fa73de680ed0e63fcbde60e88"
		)
	]
)