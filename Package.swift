...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.1.0.xcframework.zip",
			checksum: "5afb059f9585e73e8734e80682a3fffc6717b57e6dd5d3878df797000b1b41d4"
		)
	]
)