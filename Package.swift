...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.28.xcframework.zip",
			checksum: "95cd888cb44c67e40bfc61a84066adc257376bf832a68efccc2eb71df37909ae"
		)
	]
)