...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.11.xcframework.zip",
			checksum: "08a46713bc141ed2aa6f4db8b7b35629222b120ba7f4406dda6e49069895964e"
		)
	]
)