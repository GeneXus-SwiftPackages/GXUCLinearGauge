...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.4.0-beta.8.xcframework.zip",
			checksum: "2c988dd6fc24b54b70b4602d0fec69a836a1c849990fe8e606ca4f698a5e1be1"
		)
	]
)