...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-2.1.0-rc.23.xcframework.zip",
			checksum: "562b21dd52641b88ceccf14083032821e9e8dafaafc7d3e6d22efc581e052261"
		)
	]
)