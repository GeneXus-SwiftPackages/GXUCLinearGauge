...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.39.xcframework.zip",
			checksum: "3f526cd51112c99f33e7d1f694aeea28749af28274c4b8a1bac28a1935e7074b"
		)
	]
)