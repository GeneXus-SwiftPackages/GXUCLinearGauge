...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.28.xcframework.zip",
			checksum: "1864cdee54c652c32cff6c554c7dda3a93ff99ca048af2e67734533c70e29544"
		)
	]
)