...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-2.0.0-rc.34.xcframework.zip",
			checksum: "714360a2f207f11b893a33cd43204c37ebf9b86453a79684d1ad30f436e81370"
		)
	]
)