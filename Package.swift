...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.16.xcframework.zip",
			checksum: "a371950469553b16f762e30b01af8e755d7184d7d4cf549bf1bdef9ebed7ca05"
		)
	]
)