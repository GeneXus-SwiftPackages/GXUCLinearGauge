...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.13.xcframework.zip",
			checksum: "107399768d09d6863e620cc138ef1a8a6a2098e23367dd854bca7bc18f54fb9b"
		)
	]
)