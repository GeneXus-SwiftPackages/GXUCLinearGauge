...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.12.xcframework.zip",
			checksum: "7260bcdc809dfd152f35e88bfa074b96c4cde7e4581aaafa8f653c52895a3daf"
		)
	]
)