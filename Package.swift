...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.0.0-beta.14.xcframework.zip",
			checksum: "10f841616c2bf4495c08c88fc0737454b16edb10dc16389e5edd293ccd7582c1"
		)
	]
)