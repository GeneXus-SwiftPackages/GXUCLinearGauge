...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.19.xcframework.zip",
			checksum: "cc788648adf9ac66dc05e54a0b3f4b3f4cda40865e2763b4b489edde6e23ce67"
		)
	]
)