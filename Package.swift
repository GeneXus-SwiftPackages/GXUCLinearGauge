...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.2.0.xcframework.zip",
			checksum: "169236e9e570ba9cbb2b8abe4725d5e44c9afa069c7bf0c10af8ad7f7f1fe3ae"
		)
	]
)