...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.16.xcframework.zip",
			checksum: "758a2a389cf4d75c779f69a8dd8e1b8a1c0d3b6911e0a71768640489434c0aa5"
		)
	]
)