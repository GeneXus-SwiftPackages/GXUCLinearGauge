...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.0.17.xcframework.zip",
			checksum: "db7e1cae594e8bf1cb06c2b9a6415b924044c33efed73569fec6734ca982c1b9"
		)
	]
)