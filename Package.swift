...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.20.xcframework.zip",
			checksum: "998f426839a67e94c50d7b275da882964559c82bef79e7120c5a8085c5ad2249"
		)
	]
)