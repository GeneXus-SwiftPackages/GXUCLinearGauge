...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-3.0.3.xcframework.zip",
			checksum: "114e34cc7e2bed76b55292353c5bc53bf1895cfb2892a5feec696a0a08900f45"
		)
	]
)