...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.1.0-rc.25.xcframework.zip",
			checksum: "ff38b3e0e920b8dcef06a584bc0b707169c2c45daee5baaeedc86f80faa29940"
		)
	]
)