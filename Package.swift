...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.14.xcframework.zip",
			checksum: "96633c038c5c2eb39c011f5a8503151e1c0587e86ae00cae7e2ad91b8017dec6"
		)
	]
)