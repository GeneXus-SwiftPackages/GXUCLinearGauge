...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta+20230606172938.xcframework.zip",
			checksum: "0eaf208a04d09ee2748b954b197546378169fffdfefd671bedced6db2768f200"
		)
	]
)