...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-3.1.0-rc.3.xcframework.zip",
			checksum: "288cbbabcc19740f090d895866958c2bd3d3a03da4e66a3f085c97198352df7a"
		)
	]
)