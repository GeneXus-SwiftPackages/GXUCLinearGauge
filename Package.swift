...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-3.2.0.xcframework.zip",
			checksum: "0e24358dbef1f6c5284542f040a8f9e82236775a0a1ea973fb8ee5182dde5b6a"
		)
	]
)