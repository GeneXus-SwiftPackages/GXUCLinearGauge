...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.0.0-rc.43.xcframework.zip",
			checksum: "3c2f9e6d793840bd68281db0fc3b425a188532d42a9df42a5c8e54eaf773c21a"
		)
	]
)