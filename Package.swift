...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.7.xcframework.zip",
			checksum: "ec2ee261f248b2f140c2d4c909253b942c1ba197093a0b55aab2cc3816fe53c0"
		)
	]
)