...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.6.xcframework.zip",
			checksum: "6b551fb1074fe3cccc89e0f34d416fa1d9978dcebb9350958217b0b9f58706cd"
		)
	]
)