...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.0.6.xcframework.zip",
			checksum: "fc3501b15bb4bcef365899770bfbd332e8a821000fd8f49333fd0cd16ec47205"
		)
	]
)