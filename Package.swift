...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.39.xcframework.zip",
			checksum: "cd0c5ec5015e04e59d9324197d5eb1246755d4619c27b691cd41674286a1a947"
		)
	]
)