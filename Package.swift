...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.6.xcframework.zip",
			checksum: "7e1ad301f34d3e25111844ec987cccd407beefe071671fc944a214a012df6aff"
		)
	]
)