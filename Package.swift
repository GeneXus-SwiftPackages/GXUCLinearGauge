...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.3.xcframework.zip",
			checksum: "dcf95143388433f7105e46fe7f5e67180ac23a022b59fec2c7d774095183a5a7"
		)
	]
)