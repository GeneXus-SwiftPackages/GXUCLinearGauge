...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.1.0-rc.24.xcframework.zip",
			checksum: "8ccb52041a2ff8196a9be92ac60c8e56f1bdc5762a04f48fabfb09cc206e8188"
		)
	]
)