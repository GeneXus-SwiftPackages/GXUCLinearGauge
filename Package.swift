...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.2.0-rc.20.xcframework.zip",
			checksum: "20e082f40bfd04ae3749bec87de528620ba1addc673dba858cbd35c1df0af705"
		)
	]
)