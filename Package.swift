...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-1.5.0-rc.28.xcframework.zip",
			checksum: "915fd61d86335243887806938f6fcb4c2c5108ba72ef5a8ad6f4974c5d841452"
		)
	]
)