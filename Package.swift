...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.2.1.xcframework.zip",
			checksum: "e1e61592d16fb6e487c7a6ee405b4bda1bebe67d692fad156f55dc46efb1f3f4"
		)
	]
)