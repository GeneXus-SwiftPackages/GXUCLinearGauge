...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.1.0-beta.20.xcframework.zip",
			checksum: "2e6bbb579858c1e0357b8fccc8fd1e6bf8edb628f357a6e96cccd90caf04a7a2"
		)
	]
)