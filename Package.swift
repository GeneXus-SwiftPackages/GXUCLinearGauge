...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.2.0-beta.40.xcframework.zip",
			checksum: "4a88b274c0b8e0b74b14e1098909d6ad44c8d2689098f42413bc1f6f7d61425b"
		)
	]
)