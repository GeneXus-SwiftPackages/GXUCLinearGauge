...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.26.xcframework.zip",
			checksum: "dcc76aed1846382362f46a939a1e5ea1f419e222cbe4b9bc4609326029456d94"
		)
	]
)