...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.5.xcframework.zip",
			checksum: "bdeef94841ab9dffd9d3b9906efd6c6b3ee521bfc28ddd485e6eb812208f6684"
		)
	]
)