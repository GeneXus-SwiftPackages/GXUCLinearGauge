...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.3.0.xcframework.zip",
			checksum: "581ba83981a76c77734540d53fa9f0a280b90ffc3e1ba9c8e3dbaacb625954f1"
		)
	]
)