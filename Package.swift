...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-4.1.2.xcframework.zip",
			checksum: "4a750fcf11bef0f1d6f063f228df0458cd14726befdfebe28456511685cab141"
		)
	]
)