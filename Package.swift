...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCLinearGauge-4.2.0-rc.34.xcframework.zip",
			checksum: "e0cc95c05169ac80d549c72191b3be88088cec3e7cc8f3aaac91c14bd590a7f8"
		)
	]
)