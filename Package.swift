...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-2.0.0-beta.17.xcframework.zip",
			checksum: "67b77d3938f0398fb02cb1fcb62ed49c63d3111c53f16dd72818d5a86d3bec3b"
		)
	]
)