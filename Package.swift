...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.2.0-beta.24.xcframework.zip",
			checksum: "8289d2379cb3ad715af3b89fe123eeb2ed532cb171bb41e4b6804f596c88a91c"
		)
	]
)