...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.38.xcframework.zip",
			checksum: "831e28141def4b9eb37ffdd4212afc9874d16e09fb3560bd5be8b0bfad6858c9"
		)
	]
)