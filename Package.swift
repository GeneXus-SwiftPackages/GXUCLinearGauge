...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.1.xcframework.zip",
			checksum: "90d06b97566c5d649007ff4abba5bb37e9685a3984da092e38446d2c28cf7ac7"
		)
	]
)