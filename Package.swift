...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCLinearGauge-1.2.0.xcframework.zip",
			checksum: "a76f567388d3382fee7296fb95afabe50489ac4aae91ea7c360fca802f390331"
		)
	]
)