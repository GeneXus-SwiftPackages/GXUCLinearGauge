...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-4.2.0-beta.6.xcframework.zip",
			checksum: "0aee79d6f3077605f046ca73b2a91e2b21e76fe775f9b5a02e79446d29374ef0"
		)
	]
)