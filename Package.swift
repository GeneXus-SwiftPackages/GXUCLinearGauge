...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.3.0-beta.9.xcframework.zip",
			checksum: "c165b7bcd6d16793f849398fc72458c13b5dd9a584cd5ebebc9785cc326e0fbc"
		)
	]
)