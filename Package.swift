...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.15.xcframework.zip",
			checksum: "4d66df378e0f229b3d5ababf9172401a6d7c1c9f3208bde619147790e9619031"
		)
	]
)