...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.27.xcframework.zip",
			checksum: "6a083ce1a359f90cebe36dcad6ea3bf765c096e3933af48d589c9d30c4b4c282"
		)
	]
)