...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.5.0-beta.4.xcframework.zip",
			checksum: "ce02cbeaf3e409a3b2f5b2bfd7dc16fbe0f06ef62e96d02d3aa8f3b9223750c7"
		)
	]
)