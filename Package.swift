...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-1.0.0-beta+20230309134517.xcframework.zip",
			checksum: "50fd4648c213d8d43b6cf40da6f34f81c1291c4b015aaf1ab93bf3dcc5027812"
		)
	]
)