...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCLinearGauge",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCLinearGauge-3.1.0-beta.15.xcframework.zip",
			checksum: "74a8e567632bdbe71564f1f694195682d8ed962806ee7cc24f019e791129c8be"
		)
	]
)